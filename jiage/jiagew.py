...
with fileinput.input(files=('D:\code.EBK')) as f:
    for line in f:
        ...
        rs = bs.query_history_k_data(line,
                                     ...
                                     start_date='2021-10-08', end_date='',
        ...
        for el in result_list:
            pricedata= ";INSERT INTO dbo.lishijiagew (code,riqi,kai,shou,di,gao,chengjiaoliang,pctChg) VALUES ('%s', '%s','%s',N'%s',N'%s',N'%s',N'%s',N'%s')" % (el[1], el[0],el[2],el[5],el[4],el[3],el[7],el[9])
            with open('D:\\d' + str(i) + '.sql', 'a+') as f2:
                f2.write(pricedata+'\n')
            #print(result_list[0])
