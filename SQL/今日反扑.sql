...
--INTO T90
 FROM T2 
WHERE 1=1
AND  T2.k0>0 AND T2.k1<0 
--AND  T2.k2<0  
AND T2.k0g/1.009<T2.k0s  AND T2.k1d*1.009>T2.k1s 
-- AND T2.k2d*1.009>T2.k2s 
 AND T2.k0k>T2.k1s  AND T2.K0s>T2.k1k 
 AND T2.k0d*1.009>T2.k0k
 -- AND T2.k1d*1.009>T2.k1s 
...
--ΩÒ»’∑¥∆À
SELECT  * FROM T90 
WHERE riqi='2022-01-28 00:00:00.000'
